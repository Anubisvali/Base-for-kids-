 ...
 * Falls back to window.location.origin in browser if NEXT_PUBLIC_URL is not set.
 */
 ...
 */
export const APP_NAME: string = 'Base For Kids';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = 'Every mint funds a Christmas gift for an abandoned child — and grants you lasting benefits as part of the Base For Kids community.';
 ...
 */
export const APP_TAGS: string[] = ['charity', 'christmas', 'kids', 'nft', 'base'];
 ...
 */
export const APP_BUTTON_TEXT: string = 'Mint Now 🎁';
